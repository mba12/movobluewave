...
//        cell.backgroundView = UIColor(patternImage: UIImage(named:"calendarbg")!)
        ...
        let textFrame = CGRect(x: 0, y: 40-12, width: frame.size.width, height: 24)
        ...
        let textFrame2 = CGRect(x: 0, y: (80-24-1), width: frame.size.width, height: 24)
        textLabel2 = UILabel(frame: textFrame2)
        textLabel2.font = UIFont.systemFontOfSize(18)
