...
var simple = Calculator.simple_calculate_calories(int: 2000)
var complex = Calculator.calculate_calories(2000, height: 67, weight: 183, gender: "Male", birthYear: 1967, minutes: 20)


var simple2 = Calculator.simple_calculate_calories(int: 71)

var error = Calculator.calculate_calories(71, height: 70, weight: 180, gender: "Male", birthYear: 1967, minutes: 30)
